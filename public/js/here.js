    ...
    navigator.geolocation.getCurrentPosition(position =>{
        ...
        function addRouteShapeToMap(route) {
            let linestring = new H.geo.LineString(),
                routeShape = route.shape, startPoint, endPoint, polyline, routeline, svgStartMark, iconStart, startMarker, svgEndMark, iconEnd, endMarker;
            ...
            // And zoom to it's bounding rectangle
